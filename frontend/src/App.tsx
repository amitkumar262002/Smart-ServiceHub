...
import HumanChatbot from './components/HumanChatbot'
...
import MyBookingsAdvanced from './pages/MyBookingsAdvanced'
...
import FindProviderAdvanced from './pages/FindProviderAdvanced'
...
import AdvancedMapTracking from './pages/AdvancedMapTracking'
import RealVideoCall from './pages/RealVideoCall'
            ...
            <main className="container">
              <AuthGuard>
                <Routes>
                  ...
                  <Route path='/find-provider' element={<FindProviderAdvanced />} />
                  <Route path='/support' element={<Support />} />
                  
                  {/* Communication Routes */}
                  <Route path='/communication-hub' element={<CommunicationHub />} />
                  <Route path='/advanced-map-tracking' element={<AdvancedMapTracking />} />
                  <Route path='/video-call/:callId?' element={<RealVideoCall />} />
                  ...
                  <Route path='/bookings' element={<MyBookingsAdvanced />} />
